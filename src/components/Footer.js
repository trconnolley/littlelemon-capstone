        ...
        <footer className="bg-green font-section-categories primary-section">
            <div className="container grid">
                ...
                <div className="3u">
                    ...
                    <a href="https://www.facebook.com/" target="_blank"><img src={require('./../img/icon_footer_fb.png')} alt='Facebook'/></a>
                    <a href="https://www.instagram.com/" target="_blank"><img src={require('./../img/icon_footer_instagram.png')} alt='Instagram'/></a>
                    <a href="https://www.twitter.com/" target="_blank"><img src={require('./../img/icon_footer_twitter.png')} alt='Twitter'/></a>
                </div>
            </div>
        </footer>
    )
